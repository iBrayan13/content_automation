...
class WorkFlow:
    ...
    def _compile_workflow(self):
        ...
        self.workflow_app.add_conditional_edges(
            ...
            {True: "get_story_audio", False: "get_story"},
        )
        self.workflow_app.add_conditional_edges(
            "get_story",
            lambda x: x.get("end", False),
            {True: "get_story_audio", False: "get_midjourney_prompts"},
        )
        
        self.workflow_app.add_edge("get_midjourney_prompts", "get_story_audio")
        self.workflow_app.add_edge("get_story_audio", END)
